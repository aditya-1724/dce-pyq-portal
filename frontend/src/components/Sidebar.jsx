...
import profileBg from "../layout/college.jpg";  // 👈 Import profile.jpg
import {
  FaHome,
  FaBook,
  FaUser,
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 p-6 flex-1 overflow-y-auto">
        <h2 className="text-xl font-bold mb-2 text-white drop-shadow-lg">DCE Portal</h2>
        <p className="text-sm mb-6 text-white/80">👋 {studentName}</p>
